	...
	<tbody> 
			...
			<td align="center" style="color: #fff; background-color: #59ABE3; padding-top: 10px; padding-bottom: 10px; font:bold 15px arial,helvetica,sans-serif!important">
				<div style="padding-top: 20px;
					...
					<div style="width:700px;
								margin:0 auto;
								text-align: center;">
						<h2>Регистрация на сайте '.$config['site_name'].'</h2>
					</div>
				</div>
			</td> 
		</tr> 
		<tr> 
			<td bgcolor="#F5F5F5" style="color:#2c2c2b;font:16px arial,helvetica,sans-serif!important;padding:0px 30px 25px 30px" width="540">
				...
				<p>
					Вы зарегистрировались на сайте <span style="color: #59ABE3;">'.$config['site_name'].'</span>
				</p>
				<p>
					Для работы на сайте необходимо активировать учётную запись перейдя по этой <a style="color: #59ABE3;" href="'.$config['base_site_url'].'/login/activation.php?email='.$email.'&activation_code='.$activation_code.'">ссылке</a>
				</p>
				<p>
					Если она не работает, скопируйте этот код и вставьте в адресную строку браузера:<br /><br />
					<strong>'.$config['base_site_url'].'/login/activation.php?email='.$email.'&activation_code='.$activation_code.'</strong></p>
				<p>
					Если Вы не знаете о чём речь и первый раз слышите о таком сайте, то, возможно, кто-то ошибочно указал Ваш адрес электронной почты при регистрации.<br />
